...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn1=findViewById(R.id.btn1);// 버튼객체 가져오기, btn1은 정수
        ...
        //AndroidStudio의 세팅필요! ppt 참조
        btn3.setOnClickListener((v)->{
            Log.d("myapp","버튼 3이 클릭되었다");
            tvResult.setText("버튼 3번이 가장먼저 클릭욌다. ");
        ...
        class MyListener implements View.OnClickListener{
            ...
            @Override
            public void onClick(View v) { //족보상 어떠한 view도 다 받을 수 있음. 다형성!
        ...
        btnF.setOnClickListener(new MyListener("안녕5"));
        btnE.setOnClickListener(new MyListener("안녕6"));
    ...
    public void changeText(View v){
        Log.d("myapp","버튼 1이 클릭되었습니다.");//직접입력하면 안되고 ""부분만 쓰면됨
