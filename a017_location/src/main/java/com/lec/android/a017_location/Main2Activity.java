                ...
                if(btnLocate.isChecked()){ //토글버튼
                    ...
                    try {
                        ...
                        manager.requestLocationUpdates(
                                ...
                                100, //통지사이의 최소 시간간격
                                1,//통지사이의 최소 변경거리(최소 1m)
                                mLocationListener); //LocationListener: 통지받은 거리를 처리한다.
                        ...
                        Toast.makeText(getApplicationContext(),"내위치 확인 요청함",Toast.LENGTH_SHORT).show();
