...
// 뷰객체에 ContextMenu 등록하기===============================================
        ...
        switch (v.getId()){
            case R.id.tvCtxMenu:
                ...
                menu.setHeaderTitle("색상을 선택하세요")
                    //.setHeaderIcon(R.drawable.face03);
                ;
                menu.add(0,1,100,"빨강"); //0번그룹의 1번 아이템
                menu.add(0,2,100,"녹색");
                menu.add(0,3,100,"파랑");
            ...
            case R.id.ivCtxView:
                ...
                menu.add(1,1,100,"아이언맨"); //1번그룹에 1번 아이템
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        int id=item.getItemId(); //메뉴아이템의 id값값
