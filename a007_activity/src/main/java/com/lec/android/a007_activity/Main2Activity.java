 ...
 *  적층형(stack) 구조로 액티비티가 운영된다. finish가 되기 전까지 화면 전환이 되면 계속 쌓인다.
 *  finish도 화면이 없어진거지 app 이 없어진건 아니다. 사용자가 손으로 밀어서 화면 없애버려야 없어짐.
 *  code상으로 없어지는 방법은 없음.
 */
...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //findViewById: View 로부터 상속받은 그어떤것도 return 가능
        ...
        btnStartTwo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //이름, 나이 --> Person에 담은 뒤 Intent에 실어보내기
                Person p=new Person(
