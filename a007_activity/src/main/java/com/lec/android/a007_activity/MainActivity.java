...
public class MainActivity extends AppCompatActivity {
    ...
    //액티비티를 통해 다루고 있던 데이터 저장,쓰레드 중지 등의 처리를 해야한다.
    @Override
    ...
    //직전에 저장되어있던 액티비티의 상태정보가 있다면, onRestoreInstanceState 는 onStart 직후에 호출됨.
    @Override
    ...
    //액티비티 Destroy전에 호출된다. (주의: onPause 뒤에 호출된다고 간주하지 말것.)
