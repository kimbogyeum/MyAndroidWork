...
public class Main2Activity extends AppCompatActivity {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    FileWriter writer=new FileWriter(f,false); //true이면 append 모드로 생성 , write모드
    ...
    protected boolean checkExternalStorage(){
        ...
        String msg="";
        //외부메모리 상태
        if(Environment.MEDIA_MOUNTED.equals(state)){ //"mounted"라고 뜨면 장착 및 읽기,쓰기 모두 가능
            msg="외부메모리 읽기 쓰기 모두 가능";
            Log.d("myapp",msg);
            Toast.makeText(this,msg,Toast.LENGTH_LONG).show();
            return true;

        }else if(Environment.MEDIA_MOUNTED_READ_ONLY.equals(state)){ //"mounted_ro" : 읽기만 가능하다.
            //읽기 전용
            msg="외부메모리 읽기만 가능";
            Log.d("myapp",msg);
            Toast.makeText(this,msg,Toast.LENGTH_LONG).show();
